            ...
            <div className="container-fluid pt-5 bg-footer">
                            ...
                            <div className="footer-list-div">
                                ...
                                <ul>
                                    <li className="pb-3">
                                        ...
                                        <span>+65 9626 3929</span>
                                    </li>
                                    <li className="pb-3">
                                        <span className="bg-warning p-2 rounded mr-3">
                                            <FontAwesomeIcon icon="envelope" className="text-white" />
                                        </span>
                                        <span>info@treasurechope.com</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="col-12 footer-copyright">
                        <p>© 2024 Treasure Chope. All Rights Reserved. Powered By <span style={{ color: "#eb6825", fontWeight: 700 }}>Ang Yong</span></p>
                    </div>
                </div>
            </div>
        );
