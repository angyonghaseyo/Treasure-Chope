        ...
        <div className="container-fluid py-2 bg-warning">
          <div className="row">
            <div className="col-lg-4 col-md-4 col-sm-12">
              <p className="my-3 text-lg-right text-md-right text-center text-white"><b className="mr-2 h5">{this.state.restaurantCount}</b>Restaurant{this.state.restaurantCount !== 1 ? 's' : ''}</p>
            </div>
            <div className="col-lg-4 col-md-4 col-sm-12">
